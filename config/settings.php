...
return [
    ...
    'store_transaction' => [
        ...
        'default'     => 'PreAuth',
        'description' => __(
            'Store page defines how the gateway works. hosted page will redirect to a bank portal, inline form will display the CC form on your website',
            'woocommerce-nestpay'
        ),
    ],
    // SECURITY SETTINGS.
    ...
    // <code>%%m%%</code> - %s<br>
    // <code>%%y%%</code> - %s<br>',
    // __('This controls the format of the order ID generated by the gateway.
    // Change this if you are having issues with previous orders', 'woocommerce-nestpay'),
